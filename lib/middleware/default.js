...
function create(bender) {
    ...
    return function (req, res, next) {
        ...
        // serve additional configuration file for capture page
        // TODO refactoring of the idea
        if (req.url === '/js/capture-config.js') {
            return bender.utils.renderScript(res, 'BENDER_TEST_TIMEOUT = ' +
                bender.conf.testTimeout + ';');
        }
