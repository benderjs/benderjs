...
function startServer( options, config, callback ) {
	var bender = new broadway.App( {
		...
		modules = [
			utils, constants, logger, database, files, browsers, plugins, launcher, applications,
			testbuilders, pagebuilders, tests, jobs, template, sockets, middlewares, server
		];
