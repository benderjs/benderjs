...
function run() {
	...
	var args = scmd.parse();
	console.log('b');
	args.config = args.config || constants.CONFIG_NAME;
	main.start( args, {}, function() {
 ...
 */
function getSubcommander( bender ) {
	...
	parser.command( 'clean', {
		callback: main.clean.bind( bender ),
	...
	serverCmd.command( 'run', {
		callback: main.serverRun.bind( bender ),
...
module.exports.getSubcommander = getSubcommander;
