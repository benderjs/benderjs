	...
	attach: function() {
		...
		jobs.delete = function( id ) {
			function notifyTasksRemoval( id ) {
				...
				return whenCall( jobs.db.browserTasks.find, job )
		...
		jobs.edit = function( id, data ) {
			...
			function updateBrowserTasks( tasks ) {
				...
				function notifyRemove() {
					...
					return whenCall( jobs.db.browserTasks.find, query )
						.then( function( tasks ) {
		...
		jobs.checkComplete = function( id ) {
			...
			whenCall( jobs.db.browserTasks.find, query )
				.then( function( tasks ) {
