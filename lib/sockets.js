...
module.exports = {
    ...
    attach: function () {
        ...
        bender.checkDeps(module.exports.name, 'clients', 'tests');
        ...
        function handleDashboard(socket) {
            ...
            socket.on('register', function () {
                ...
                socket.emit('clients:update', bender.clients.get());
            ...
            socket.on('run', function (ids) {
                if (bender.clients.checkReady()) {
                    bender.clients.setBusy(true);
                    bender.emit('test:run', ids);
                    sockets.clients.json.emit('run', ids);
                } else {
        ...
        function handleClient(socket) {
            ...
            socket.on('complete', function (data) {
                socket.get('id', function (err, id) {
                    ...
                    bender.clients.setBusy(id, false);
