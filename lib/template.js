...
module.exports = {
	...
	attach: function() {
		...
		template.build = function( data ) {
			// Contains the list of files to be injected into the test.
			data.files = {
				css: [],
				js: [],
				code: []
			...
			data.addCSS = function( url, options ) {
				data.files.css.push( {
					url: url,
					options: options || {}
				} );
			...
			data.addJS = function( url, options ) {
				data.files.js.push( {
					url: url,
					options: options || {}
				} );
			...
			data.addCode = function( code, options ) {
				data.files.code.push( {
					code: code,
					options: options || {}
				} );
			};
